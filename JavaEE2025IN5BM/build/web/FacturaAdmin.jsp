    ...
    <main class="crud-main">
        <section class="top-container">
            ...
            <div class="formulario">
                ...
                <form>
                    <label for="numero-factura">No. Factura</label>
                    <input type="text" id="numero-factura" placeholder="Ej: 1020" />

                    <label for="numero-cliente">Cliente</label>
                    <input type="text" id="numero-cliente" placeholder="Nombre del cliente" />

                    <label for="numero-empleado">Empleado</label>
                    <input type="text" id="numero-empleado" placeholder="Empleado a cargo" />

                    <label for="numero-automovil">Automóvil</label>
                    <input type="text" id="numero-automovil" placeholder="Vehículo" />

                    <label for="numero-gasto">Tipo de gasto</label>
                    <input type="text" id="numero-gasto" placeholder="Servicio, Repuesto, etc." />

                    <label for="numero-cantidad">Cantidad</label>
                    <input type="number" id="numero-cantidad" placeholder="Ej: 2" />

                    <label for="numero-precio">Precio</label>
                    <input type="number" id="numero-precio" placeholder="Q0.00" />
